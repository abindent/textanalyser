...
const Showcase = () => {
  return (
    <div>
      ...
      >
        <Typography variant="h2" align="center" justifyContent={"center"}>Analyser</Typography>
        <PRISMLoader>
          <pre className="line-numbers" data-src="/showcase/scripts/analyser.ts"></pre>
        </PRISMLoader>
        <br/>
        <Typography variant="h2" align="center" justifyContent={"center"}>Styler</Typography>
